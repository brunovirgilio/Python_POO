...
class Luta:
    ...
    def Resultado(self):
        ...
        print('|','='*50,'|')
        print(' '*11,f'{self.nome1} fez {self.ponto1} ponto(s)',' '*14)
        print(' '*11,f'{self.nome2} fez {self.ponto2} ponto(s)',' '*14)
        print('|','='*50,'|')
        if self.ponto1 > self.ponto2:
            print('+'*14,f'{self.nome1:} GANHOU','+'*14)
        elif self.ponto1 < self.ponto2:
            print('+'*14,f'{self.nome2:} GANHOU','+'*14)
        else:
            print(  '+'*15,'A luta foi EMPATADA','+'*15)
        print('|','='*50,'|')
